...
exports.createTag = async (req, res) => {
  ...
  try {
    ...
    const existing = await Tag.findOne({ where: { name, workspace_id: req.workspace_id } });
    if(existing) {
...
exports.updateTag = async (req, res) => {
  ...
  try {
    ...
    const tag = await Tag.findOne({ where: { id: req.params.id, workspace_id: req.workspace_id } });
